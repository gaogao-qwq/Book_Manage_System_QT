...
#include "ui_bookAnalysisWindow.h"


book_analysis_window::book_analysis_window(QWidget *parent, BookList *list) :
        QWidget(parent), ui(new Ui::book_analysis_window), bookList(list) {
    ui->setupUi(this);
    // 不允许编辑
...
void book_analysis_window::on_pressComboBox_currentTextChanged(const QString &text) {
...
void book_analysis_window::on_authorComboBox_currentTextChanged(const QString &text) {
...
void book_analysis_window::on_exitButton_clicked() {
